              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center">
                  <div className="relative">
                    <div className="w-16 h-16 rounded-2xl overflow-hidden border-2 border-blue-100 shadow-lg">
                  ...
                  <div className="ml-4">
                    <h3 className="text-xl font-bold text-gray-800">
                      {user?.nama_depan || "Guide"} {user?.nama_belakang || ""}
                    </h3>
                    <p className="text-gray-500 text-sm">
                      {user?.email || "guide@summitcs.com"}
                    </p>
                  </div>
                </div>
                <button
