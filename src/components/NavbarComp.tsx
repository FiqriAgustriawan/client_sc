    ...
    <>
      ...
      >
        <div className="flex items-center justify-between w-full">
          ...
          {/* Login and Register button for desktop */}
          <div className="hidden xl:flex items-center z-10 mr-4 sm:mr-[1.75rem]">
            <Link href="/login">
              <button
                type="button"
                className="bg-gradient-to-br from-[#9CCAFF] via-[#4A90E2] to-[#0080FF] hover:from-[#8BB8FF] hover:via-[#3A80D2] hover:to-[#0070EF] text-white font-semibold px-6 py-2 rounded-full focus:outline-none transition-all duration-300 ease-in-out"
              >
                Login
              </button>
            </Link>
            <Link href="/register">
              <button
                type="button"
                className="bg-gradient-to-br from-[#9CCAFF] via-[#4A90E2] to-[#0080FF] hover:from-[#8BB8FF] hover:via-[#3A80D2] hover:to-[#0070EF] text-white font-semibold px-6 py-2 rounded-full focus:outline-none transition-all duration-300 ease-in-out ml-2"
              >
                Register
              </button>
            </Link>
