...
export default function DashboardUserPage() {
  ...
  // Menggunakan SidebarContext untuk mengetahui status sidebar
  ...
  useEffect(() => {
    ...
    setIsFormComplete(
      Boolean(gender && tanggal_lahir && nik && tempat_tinggal)
    );
  }, [formData]);
    ...
    try {
      ...
      if (result.success) {
        ...
        toast({
          title: (
            <div className="flex items-center gap-3">
              <div className="relative">
                ...
                <svg
                  className="w-6 h-6 text-green-500 relative animate-bounce"
                  viewBox="0 0 24 24"
                >
                  <path
                    fill="currentColor"
              ...
              <span className="font-bold tracking-wide text-lg animate-fade-in">
                Kontak Diperbarui!
              </span>
            </div>
          ),
          ...
          className:
            "animate-toast-slide bg-gradient-to-br from-green-600 via-emerald-600 to-teal-600 text-white border-none shadow-2xl shadow-green-500/30 backdrop-blur-md",
          duration: 5000,
          style: {
            animation:
              "slide-up 0.4s ease-out, fade-out 0.4s ease-in forwards 4.6s",
        ...
        toast({
          ...
          variant: "destructive",
          className:
            "bg-gradient-to-r from-red-500 to-rose-500 text-white border-none shadow-lg shadow-red-500/30 animate-toast-slide",
          duration: 3000,
        });
      }
    } catch (error) {
        ...
        if (profileResult.success) {
          ...
          setFormData((prev) => ({
            ...
            tanggal_lahir: profileResult.data.tanggal_lahir
              ? new Date(profileResult.data.tanggal_lahir)
                  .toISOString()
                  .split("T")[0]
              : "",
  ...
  return (
    // Menambahkan kelas transisi dan margin yang menyesuaikan dengan status sidebar
    <div
      className={`min-h-screen bg-gradient-to-b from-gray-50   -mt-5 to-gray-100 flex flex-col transition-all duration-300 ease-in-out ${
        sidebarOpen ? "md:ml-[0px]" : "md:ml-[0px]"
      }`}
    >
      {/* Header Background dengan transisi halus saat sidebar berubah */}
      <div className="relative">
         ...
         {/* Header Content with better spacing and positioning */}
                ...
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 md:mb-10">
                  ...
                  <p className="text-blue-100 text-sm md:text-base max-w-xl">
                    Kelola informasi pribadi, kontak, dan akun terhubung Anda
                  ...
                  <Image
                    ...
                    onError={(e) => {
                      ...
                      <div className="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all duration-300">
                        ...
                        strokeLinejoin="round"
                        strokeWidth={2}
                        d="M3 9a2 2 0 012-2h.93a2 2 0 001.664-.89l.812-1.22A2 2 0 0110.07 4h3.86a2 2 0 011.664.89l.812 1.22A2 2 0 0018.07 7H19a2 2 0 012 2v9a2 2 0 01-2 2H5a2 2 0 01-2-2V9a2 2 0 012-2zm8-2V7a4 4 0 00-8 0v4h8z"
                        />
                        </svg>
                        </div>
                      </div>
                      ...
                      whileTap={{ scale: 0.95 }}
                      onClick={() => router.push('/dashboard-user/trip-manage')}
          ...
          {activeTab === "profile" && (
            ...
            >
              <div className="flex items-center mb-6">
                ...
                <h2 className="text-xl font-medium text-[#2D3648]">
                  Data Pribadi
                </h2>
              </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-6 gap-6">
                  <div className="space-y-2 md:col-span-6">
                    ...
                    <p className="text-xs text-gray-500 mt-1">
                      Nama lengkap diambil dari data registrasi dan tidak dapat
                      diubah.
                    </p>
                  </div>
                  ...
                  <div className="space-y-2 md:col-span-4">
                    <label className="block text-sm text-[#6B7280]">
                      Tanggal Lahir{" "}
                      <RequiredIndicator value={formData.tanggal_lahir} />
                    </label>
                    <input
                      type="date"
                      name="tanggal_lahir"
                    ...
                    {formData.tanggal_lahir && (
                      <p className="text-sm text-[#6B7280] mt-1">
                        {new Date(formData.tanggal_lahir).toLocaleDateString(
                          "id-ID",
                          {
                            day: "numeric",
                            month: "long",
                  ...
                  <div className="space-y-2 md:col-span-4">
                    <label className="block text-sm text-[#6B7280]">
                      Tempat Tinggal{" "}
                      <RequiredIndicator value={formData.tempat_tinggal} />
                    </label>
                    <input
                      type="text"
                      name="tempat_tinggal"
              ...
              <div className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    ...
                    <p className="text-xs text-gray-500 mt-1">
                      Email diambil dari data registrasi dan tidak dapat diubah.
                    </p>
                  </div>
                          ...
                          <div className="flex-1 px-4 py-3 rounded-xl border border-[#E5E7EB] bg-[#F9FAFB] text-[#2D3648] text-sm flex items-center justify-between">
                            <div className="flex items-center">
                              ...
                              >
                                <path
                                  fillRule="evenodd"
                                  d="M10 18a8 8 0 100-16 8 8 0 000 16zm-7 9a7 7 0 1114 0H3z"
                                  clipRule="evenodd"
                                />
                              </svg>
                              {formData.nomor_telepon}
                    ...
                    {showPhoneInput && (
                      <div className="space-y-3">
                        <div className="relative">
                          <input
                            ...
                            className={`w-full px-4 py-3 rounded-xl border ${
                              phoneError ? "border-red-500" : "border-[#E5E7EB]"
                            } bg-[#F9FAFB] text-[#2D3648] text-sm focus:outline-none focus:ring-1 focus:ring-[#4A90E2]`}
                          />
                          {phoneError && (
                        ...
                        <p className="text-xs text-gray-500">
                          Nomor telepon akan digunakan untuk verifikasi dan
                          komunikasi penting terkait trip Anda.
                        </p>
                      </div>
                    )}
                  </div>
                ...
                <div className="border-t border-gray-200 pt-6 mt-6">
                  <h3 className="text-md font-medium text-[#2D3648] mb-4">
                    Kontak Darurat
                  </h3>
                    ...
                    <div className="flex items-start">
                      ...
                      <div className="ml-3">
                        ...
                        <div className="mt-2 text-sm text-blue-700">
                          <p>
                            Kontak darurat akan dihubungi jika terjadi keadaan
                            darurat selama perjalanan Anda. Pastikan untuk
                            menambahkan setidaknya satu kontak darurat sebelum
                            melakukan pemesanan trip.
                          </p>
                        </div>
                      </div>
                    </div>
                ...
                <div className="bg-blue-50 border border-blue-200 rounded-xl p-4 mb-6">
                  <div className="flex items-start">
                    ...
                    <div className="ml-3">
                      ...
                      <div className="mt-2 text-sm text-blue-700">
                        <p>
                          Menghubungkan akun media sosial memungkinkan Anda
                          untuk login dengan cepat dan berbagi pengalaman trip
                          Anda dengan mudah.
                        </p>
                      </div>
                    </div>
